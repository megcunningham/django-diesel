...
Using django for team diesel app
...
megs_project relies extensively on environment settings which **will not work with Apache/mod_wsgi setups**. It has been deployed successfully with both Gunicorn/Nginx and even uWSGI/Nginx.

For configuration purposes, the following table maps the 'megs_project' environment variables to their Django setting:
...
DJANGO_DEFAULT_FROM_EMAIL               DEFAULT_FROM_EMAIL          n/a                                            "megs_project <noreply@example.com>"
DJANGO_SERVER_EMAIL                     SERVER_EMAIL                n/a                                            "megs_project <noreply@example.com>"
DJANGO_EMAIL_SUBJECT_PREFIX             EMAIL_SUBJECT_PREFIX        n/a                                            "[megs_project] "
...
To run the tests, enter the megs_project/tests directory and run the following commands::
...
Postgres is saving its database files to `/data/megs_project/postgres` by default. Change that if you wan't
...
If you are using `supervisor`, you can use this file as a starting point::
    ...
    [program:megs_project]
    command=docker-compose up
    directory=/path/to/megs_project
...
Place it in `/etc/supervisor/conf.d/megs_project.conf` and run::

    supervisorctl reread
    supervisorctl start megs_project
